...
class ZeroIsMaxDateTimeField(field: DateTimeField, `type`: DateTimeFieldType)
  ...
  override def add(instant: Long, value: Int): Long = getWrappedField.add(instant, value)

  override def add(instant: Long, value: Long): Long = getWrappedField.add(instant, value)
  ...
  override def getMinimumValue(instant: ReadablePartial, values: Array[Int]): Int = 1
