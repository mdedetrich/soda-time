...
object DateTimeFormat {
  ...
  private val cPatternCache = new ConcurrentHashMap[String, DateTimeFormatter]()
  ...
  object StyleFormatter {
    ...
    private val cCache = new ConcurrentHashMap[StyleFormatterCacheKey, DateTimeFormatter]()
  }
